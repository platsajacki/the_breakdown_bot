...
class InfoMessage:
    ...
    WALLET_MASSAGE: str = (
        f'_____________{MONEY_BAG}_____________'
        + '''
Equity - <b>{equity}</b>
...
Realised PNL - <b>{real_pnl}</b>'''
    ...
    OPEN_ORDER_MESSAGE: str = (
        '''<b>The order was opened!</b>
'''
        + f'{MONEY_WITH_WINGS} '
        + '''<b>{symbol}</b>
...
Create - <b>{create}</b>'''
    ...
    def get_text_not_worked_out_level(
        ...
        avg_info = (
            ...
            if median_price and current_price_movement
